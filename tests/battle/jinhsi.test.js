...
describe('battle/characters/jinhsi — 今汐', () => {
  ...
  it('C3 变奏谪仙 atk+50%；C4 惊龙/解放全队 allDmgUp；C6 forte ×2.2', () => {
    ...
    expect(unit.forte.effectMult).toBeCloseTo(2.2, 5); // 1.8+0.4
  ...
  it('skillHints C6 惊龙/解放数字含 C1/C5 与 ×2.2', () => {
