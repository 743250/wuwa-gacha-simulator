...
- **Phase 3**:combat.js hook 收口(顶部 0 角色 import,`fireCharacterHook`/`queryCharacterHook` 全面派发)+ render.js 拆分(1349 → 57 行,7 个子模块)+ `startEncounter` 统一入口
...
- src/ui/render.js 57 行 · render/ 7 子模块(待迁 Preact — 见 plan.md Stage 2 / 3 / 5)
