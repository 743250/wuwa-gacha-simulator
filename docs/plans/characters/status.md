...
| 守岸人 | 衍射 | 音感仪 | 辅助 | 1.3 | S | **SS** | ✅ | ✅ 星域展开立即回血+HOT 5%/40%/C1–C6+技能×80%（2026-07-15 复验） | [守岸人.md](守岸人.md) |
...
| 夏空 | 气动 | 佩枪 | 辅助 | 2.3 | **S** | **S** | ✅ | ✅ 音律/四拍/独奏/演绎+解放1100·550/skillHints（2026-07-15 倍率） | [夏空.md](夏空.md) |
...
| 弗洛洛 | 湮灭 | 音感仪 | 主C | 2.5 | **S** | **SS** | ✅ | 🔧 2026-07-16 ATK 核重校准（撤销误判 HP 核；指挥攻击+120%；谱曲绝对加点；C6 216.4%/36%）；🔧 **2026-08-01 重设计**：谱曲余响 30%→官方 82.55%、谱曲 CD 1→3、C3 重击加深→赫卡忒×1.8、C4 双算修复、C6 湮灭+60% 仅指挥内、敌人 DEF 统一官方 792+8×等级（Lv90=1512） | [弗洛洛.md](弗洛洛.md) |
| 奥古斯塔 | 导电 | 长刃 | 主C | 2.6 | **S** | **SS** | ✅ | ✅ 威慑/冕层/赫日威临+skillMult/禁切/skillHints（2026-07-13） | [奥古斯塔.md](奥古斯塔.md) |
| 尤诺 | 气动 | 臂铠 | 主C | 2.6 | **S** | **S** | ✅ | ✅ 灵性/月相/满月/至臻+解放400·200/变奏80%+skillHints（2026-07-15） | [尤诺.md](尤诺.md) |
...
**4★ 工厂版** customLines + 标准 chain effect；**2026-07-15 倍率校准**：`characters/index.js` LIGHTWEIGHT 挂 N/S/H/B/V hook（encore Lv10 抽象），skillHints cfg 同源。机制仍工厂级，不写专属状态机。

### 倍率重校准后需复验（2026-07-15）
全局默认与大量 ATK 角 hook 已改（重击 400 / 解放 700·350 等）。下列**战斗验收 ✅ 仍有效**，但深塔/危险区通关手感建议抽查一轮（只动敌人 HP 曲线，不回调角色倍率）：
- 主 C ATK：忌炎 / 安可 / 卡卡罗 / 今汐 / 椿 / 珂莱塔 / 菲比 / 嘉贝莉娜 / 仇远 / 露帕 / 尤诺
- 副 C / 辅：吟霖 / 长离 / 折枝 / 相里要 / 夏空 / 坎特蕾拉 / 洛可可 / 布兰特 / 守岸人 / 凌阳 / 鉴心 / 维里奈
- HP 核（倍率未粘贴 ATK，表已对账 MATCH）：卡提希娅 / 赞妮 / 奥古斯塔 / 千咲
- 主 C ATK（2026-07-16 重校准）：弗洛洛
- 4★ 十二人：已挂专属倍率，深塔稳定区若过快只调敌人
...
| 秧秧·玄翎 | 湮灭 | 迅刀 | 主C | 3.5 | A → 工厂 | **S** | ✅ | ✅ 苍翎满 2 层强化重击×2.0（atk×800%）+ C1 技能 +30% / C2 重击 +100% / C3 解放 +100% / C4 全队攻击 +20% / C5 防御 +20% / C6 重击 +40% + skillHints 对账（2026-08-15） | [秧秧·玄翎.md](秧秧·玄翎.md) |
| 穗穗 | 冷凝 | 音感仪 | 辅助 | 3.5 | A → 工厂 | **S** | ✅ | ✅ 山河水境 4 回合（立即回血 + HOT + 全队全伤害 +25%）+ 醒春潮全队治疗 + C4 治疗 +50% + skillHints 对账（2026-08-15） | [穗穗.md](穗穗.md) |
| 清宵 | 气动 | 迅刀 | 主C | 3.6 | C 级占位 | 待定 | ✅（可抽取） | 未（等 8/20 上线后补官方数据） | — |
| 景燃 | 热熔 | 长刃 | 主C | 3.6 | C 级占位 | 待定 | ✅（可抽取） | 未（等 8/20 上线后补官方数据） | — |

## 剩余待移植(按版本顺序)

- 3.6 清宵 / 景燃 — 待官方上线后补 A 级实装（当前 C 级占位，可抽取可养成，无专属战斗机制）
