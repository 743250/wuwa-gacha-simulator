...
| 角色 | 元素 | 武器 | 类型 | 上线 | 移植级别 | 强度 Tier | 状态 | 计划文件 |
|---|---|---|---|---|---|---|---|---|
| 琳奈 | 衍射 | 佩枪 | 副C | 3.0 | A → 工厂(重击型) | **SS** | ✅ 已实装(工厂版 · 溢彩/流光/灵感碰撞/绮彩巡游) | [琳奈.md](琳奈.md) |
| 莫宁 | 冷凝 | 迅刀 | 主C | 3.0 | A → 工厂 | **SS** | ✅ 已实装(工厂版 · 协奏能量175/干涉标记/谐振场) | [莫宁.md](莫宁.md) |
| 爱弥斯 | 导电 | 长刃 | 主C | 3.1 | A → 工厂(重击型) | **S** | ✅ 已实装(工厂版 · 同步率/光翼共奏/震谐聚爆双模态) | [爱弥斯.md](爱弥斯.md) |
| 陆·赫斯 | 冷凝 | 臂铠 | 辅助 | 3.1 | A → 工厂 | **S** | ✅ 已实装(工厂版 · 谐度/黄金的裁量/集谐·偏移·干涉) | [陆·赫斯.md](陆·赫斯.md) |
| 西格莉卡 | 衍射 | 音感仪 | 主C | 3.2 | A → 工厂(重击型) | **S** | ✅ 已实装(工厂版 · 凝语/天赋？/我即语义/符文组合) | [西格莉卡.md](西格莉卡.md) |
| 绯雪 | 冷凝 | 迅刀 | 主C | 3.3 | A → 工厂(重击型) | **S** | ✅ 已实装(工厂版 · 心念300/雪锈/预求身/居合/霜渐效应) | [绯雪.md](绯雪.md) |
| 达妮娅 | 热熔 | 佩枪 | 主C | 3.3 | A → 工厂 | **S** | ✅ 已实装(工厂版 · 黯核3/虚质粒子/布景·幻灭双形态) | [达妮娅.md](达妮娅.md) |
| 露西 | 衍射 | 佩枪 | 主C | 3.4 | A → 工厂(重击型) | **S** | ✅ 已实装(工厂版 · 传输协议/Ram/欺骗程式/骇破·偏移) | [露西.md](露西.md) |
| 丽贝卡 | 导电 | 佩枪 | 副C | 3.4 | A → 工厂(重击型) | **S** | ✅ 已实装(工厂版 · 狂热120/手感火热/街头直觉/猎手·铁胆) | [丽贝卡.md](丽贝卡.md) |
| 洛瑟菈 | 湮灭 | 音感仪 | 副C | 3.4 | A → 工厂 | **S** | ✅ 已实装(工厂版 · 印象/照片/追忆/断舍离/铭记) | [洛瑟菈.md](洛瑟菈.md) |
