...
import { startEncounter, getCombatTeamNames, canAttack, canSkill, canHeavy, canBurst } from '../battle/combat.js';
...
import { renderTeamHTML, renderSkillPanelHTML, renderWeaponStacksHTML } from './battle/teamRenderer.js';
...
function renderSkillPanel(cur) {
  return renderSkillPanelHTML(cur);
}

// 渲染角色当前武器叠层标签
function renderWeaponStacks(t) {
  return renderWeaponStacksHTML(t);
}
