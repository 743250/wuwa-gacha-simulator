...
export const TERM_DICT = {
  ...
  '谱曲终末': '<b style="color:#ff6b9d">谱曲终末</b>（弗洛洛重击替换 · 共鸣技能伤害 + 声骸技能）<br>乐声满 6 枚时，重击替换为谱曲终末。施放时消耗 2 AP，冷却 1 回合，消耗全部 6 枚乐声。对主目标造成弗洛洛最大生命 20% 的湮灭范围伤害（视为共鸣技能伤害及声骸技能伤害）。每层<b class="term-resource">余响</b>使本次伤害倍率提升 20%（2 链为 35%），余响满 24 层时倍率额外 ×3.0。施放后进入<b class="term-state">定音</b>状态。<br>2 链：基础倍率提升 75%，余响增伤效果提升 75%，施放后获得 14 层余响。3 链：声骸技能伤害加深 80%。',
