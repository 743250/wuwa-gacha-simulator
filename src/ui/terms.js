...
export const TERM_DICT = {
  ...
  '余响': '<b style="color:#c39bff">余响</b>（弗洛洛共鸣回路 · 上限 24 层）<br>各种招式命中时积累，战斗开始时获得 10 层（固有·八重奏）。每层余响使<b class="term-heavy">谱曲终末</b>伤害倍率线性提升 60%（2 链为 105%）。每层余响使弗洛洛暴击伤害提升 2.5%（固有·八重奏）。',
  ...
  '指挥状态': '<b style="color:#9b6dff">指挥状态</b>（弗洛洛共鸣解放后状态 · 持续 3 回合）<br>施放<b style="color:var(--gold)">共鸣解放·往日深渊的圆舞曲</b>后进入，持续 3 回合。指挥状态期间：弗洛洛攻击力提升 120%，本人可正常行动；召唤<b class="term-resource">赫卡忒</b>协助战斗，赫卡忒每回合自动攻击；弗洛洛受到的伤害优先由赫卡忒承担，溢出部分由弗洛洛承担；赫卡忒生命值归零时指挥状态立即结束。切换其他角色时指挥状态结束，赫卡忒随之消散。<br>5 链：指挥状态期间赫卡忒及弗洛洛受到的伤害降低 30%。<br>6 链：弗洛洛为登场角色时湮灭伤害加成提升 60%；弗洛洛为非登场角色时，目标受到赫卡忒和弗洛洛的伤害提升 40%。',
  '赫卡忒': '<b style="color:#9b6dff">赫卡忒</b>（弗洛洛召唤单位 · 指挥状态期间存在）<br>弗洛洛进入指挥状态时召唤。生命值等于弗洛洛生命值，继承弗洛洛属性。每回合自动攻击主目标，造成弗洛洛最大生命 12% 的湮灭伤害（视为共鸣解放伤害），每次命中获得 1 枚<b class="term-resource">乐声</b>及 2 层<b class="term-resource">余响</b>。每第 2 次自动攻击后施放强化攻击·赫卡忒，造成弗洛洛最大生命 24% 的湮灭伤害（6 链为 29.76%），额外获得 1 枚乐声及 3 层余响。弗洛洛受到伤害时优先由赫卡忒承担，溢出部分由弗洛洛承担。赫卡忒生命值归零时消散，指挥状态立即结束。不可被玩家操控，不可切换。',
  '谱曲终末': '<b style="color:#ff6b9d">谱曲终末</b>（弗洛洛重击替换）<br>乐声满 6 枚时，重击替换为谱曲终末。施放时消耗 2 AP，冷却 1 回合，消耗全部 6 枚乐声。对主目标造成弗洛洛最大生命 20% 的湮灭范围伤害（视为重击伤害）。每层<b class="term-resource">余响</b>使本次伤害倍率线性提升 60%（2 链为 105%）。施放后进入<b class="term-state">定音</b>状态。<br>2 链：基础倍率提升 75%，余响增伤效果提升 75%，施放后获得 14 层余响。3 链：谱曲终末伤害加深 80%。',
  ...
  '永恒位格': '<b style="color:var(--gold)">永恒位格</b>（嘉贝莉娜解放强化 · 持续战斗剩余时间）<br>进入方式：释放<b style="color:var(--burst)">共鸣解放·永恒位格</b>触发。<br>· 6 链：自身全伤害 +<b>60%</b>，余火满层热熔加深 +<b>35%</b><br>· 4 链：共鸣解放后全队伤害 +<b>20%</b><br>· 是嘉贝莉娜的主输出窗口，配合重击·炼羽裁决',
