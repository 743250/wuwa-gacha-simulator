...
export const TERM_DICT = {
  ...
  '光致变染': '<b style="color:#ff8c5e">光致变染</b>（琳奈 debuff · 持续伤害）<br>琳奈招式命中附加。每回合造成 atk×30% 衍射伤害，持续 2 回合（1 链 +1 回合）。',
  ...
  '干涉标记': '<b style="color:#7bd6ff">干涉标记</b>（莫宁标记 debuff · 挂在敌人身上）<br>普攻/技能命中附加。莫宁对干涉目标的伤害 +15%。<br>· 2 链：全队对干涉目标暴击伤害 +32%',
  ...
  '震谐轨迹': '<b style="color:#7bd6ff">震谐轨迹</b>（爱弥斯震谐模态 debuff）<br>震谐模态下重击/技能命中附加。每回合 atk×30% 导电持续伤害。6 链层数翻倍。',
  '聚爆效应': '<b style="color:#7bd6ff">聚爆效应</b>（爱弥斯聚爆模态可引爆 debuff）<br>聚爆模态下命中附加。重击或光翼共奏命中引爆时 +150% 伤害。6 链可暴击。',
  ...
  '集谐·偏移': '<b style="color:#7bd6ff">集谐·偏移</b>（陆·赫斯标记 debuff · 挂在敌人身上）<br>普攻/变奏/技能命中附加。持续 25 秒。谐度破坏触发后转化为集谐·干涉层数。',
  ...
  '欺骗程式': '<b style="color:#7bd6ff">欺骗程式</b>（露西 debuff · 5 种变体）<br>义体故障/突破协议/运动失能/武装故障/赛博精神病。露西招式附加。2 链黑墙深度记录后激活快捷响应，可对范围目标附加。',
  '骇破·偏移': '<b style="color:#7bd6ff">骇破·偏移</b>（露西标记 debuff · 挂在敌人身上）<br>共鸣技能/重击/解放命中附加。6 链下目标受露西重击伤害 +40%、骇破伤害 +60%。',
