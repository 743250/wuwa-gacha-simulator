...
export const TERM_DICT = {
  ...
  // ===== 其他角色专属（后续做哪个角色补哪个）=====
  '离火': '<b style="color:#ff8c5e">离火</b>（长离共鸣回路 · 0-3 层）<br>普攻每 3 段 +1 / 共鸣技能 +1 / 解放 +1。<br><b style="color:#ff8c5e">重击·焚身以火</b>消耗 <b>1</b> 层，每层让本次伤害 +50%。',
  ...
  '墨鹤': '<b style="color:#7bd6ff">墨鹤</b>（折枝召唤物 · 上限 6 / 12）<br><b style="color:var(--burst)">共鸣解放·虚实境趣</b>召唤 6 只墨鹤（2 链上限 +6 = 12 只）。<br>切下场后<b>每回合自动协同攻击</b>，每只造成 atk×30% 衍射（5 链 +40% 倍率）。',
  ...
  '标记': '<b style="color:var(--gold)">标记</b>（卡提希娅专属资源 · 上限 3 层）<br>普攻/重击/共鸣技能命中时获得 <b>1</b> 层（持续 2 回合，获得新标记时刷新全部持续时间）。<br>每层：自身<b class="term-normal">气动伤害</b> +<b>10%</b>。消耗全部层数进入芙露德莉斯形态。',
  '人权': '<b style="color:#6bb5ff">人权</b>（卡提希娅形态之力 · 消耗 1 层标记获得）<br>芙露德莉斯形态下防御力增强，受到伤害 <b>-30%</b>。',
  '神权': '<b style="color:var(--gold)">神权</b>（卡提希娅形态之力 · 消耗 2 层标记获得）<br>芙露德莉斯形态下暴击率 <b>+25%</b>。',
  '异权': '<b style="color:#ff6b9d">异权</b>（卡提希娅形态之力 · 消耗 3 层标记获得）<br>芙露德莉斯形态下，非大招技能（普攻/重击/共鸣技能）叠加 <b>2 层</b>风蚀效应（取代 1 层）。',
  '风蚀效应': '<b style="color:var(--green)">风蚀效应</b>（卡提希娅 DoT）<br>芙露德莉斯形态下攻击/技能给目标附加。<br>敌人回合开始时造成伤害 = 敌人攻击力 × 层数 × <b>0.3</b>。<br>芙露德莉斯形态第二次解放·看潮怒风哮之刃：每层 <b>+20%</b> 伤害，施放后清空全部风蚀。',
  '芙露德莉斯': '<b style="color:#a78bff">芙露德莉斯形态</b>（卡提希娅解放强化 · 持续 3 回合）<br>进入方式：共鸣解放·听骑士从心祈愿（消耗全部【标记】层数）<br>· 每次攻击/技能给目标附加 <b>1</b> 层风蚀效应（异权：<b>2</b> 层）<br>· 命中额外回复 <b>+8</b> 共鸣能量<br>· 再次释放共鸣解放 → 看潮怒风哮之刃：风蚀爆发终结<br>形态结束时清除人权/神权/异权状态。',
  ...
  '协同攻击': '<b style="color:var(--accent)">协同攻击</b>（召唤物/链接攻击）<br>角色下场后由召唤物/连接物自动触发的攻击。每回合自动结算，享受当前角色的攻击/暴击。<br>典型代表：折枝·墨鹤、莫特斐·浮翼狂想协同、维里奈 6 链协同。',
  ...
  '白鹤': '<b style="color:#7bd6ff">白鹤</b>（折枝 6 链召唤物）<br>施放<b style="color:var(--accent)">共鸣技能·神来之笔</b>或<b>极意·神来之笔</b>时，额外召唤 <b>1</b> 只白鹤，造成神来之笔 <b>120%</b> 的伤害（视为<b style="color:var(--text)">普攻</b>类型）。',
