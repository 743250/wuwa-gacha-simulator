...
export const TERM_DICT = {
  ...
  '焕彩': '<b style="color:var(--gold)">焕彩</b>（珂莱塔解放 · 停滞效果）<br><b style="color:var(--burst)">共鸣解放·死兆</b>的射击命中目标时附加：<br>· 目标持续时间内无法行动（停滞）<br>· 受到伤害或持续 <b>1.5</b> 秒时清除',
  ...
  '集谐·偏移': '<b style="color:#7bd6ff">集谐·偏移</b>（陆·赫斯标记 · 挂在敌人身上）<br>普攻/变奏/技能命中附加。持续 25 秒。谐度破坏触发后转化为集谐·干涉层数。',
  ...
  '寒意': '<b style="color:#7bd6ff">寒意</b>（绯雪资源 · 预求身期间持续消耗）<br>进入预求身状态后持续消耗寒意，12 秒后退出。共鸣技能霜罚·白玉切/落华可附寒意。',
  ...
  '预求身': '<b style="color:#7bd6ff">预求身</b>（绯雪拔刀姿态）<br>重击·寒簇·常世身施放后或共鸣解放后进入。期间普攻替换为<b>居合斩</b>，重击替换为<b>重击·枯霜·预求身</b>。持续消耗寒意，12 秒后退出。',
  '居合斩': '<b style="color:#7bd6ff">居合斩</b>（绯雪预求身普攻替换）<br>预求身期间普攻替换为此招。高倍率冷凝伤害，命中附加霜渐效应。2 链伤害 +125%。',
  '霜渐效应': '<b style="color:#7bd6ff">霜渐效应</b>（冷凝类 DoT）<br>绯雪招式命中附加。每 2 秒触发霜冻伤害，3 层雪锈时附加额外异常倍率。',
  ...
  '熵变强化': '<b style="color:#ff8c5e">熵变强化</b>（达妮娅强化状态）<br>入战即获得（布景 30 秒 / 幻灭 12 秒）。期间虚质粒子获取 +100%，3 链下黯核回满。',
  '蚀域': '<b style="color:#ff8c5e">蚀域</b>（达妮娅解放后领域）<br>共鸣解放·帷幕终景·幻灭之形后生成，持续 30 秒，每 4 秒发动 1 次造成热熔伤害（视为共鸣解放伤害）。',
  ...
  '协议界面': '<b style="color:#7bd6ff">协议界面</b>（露西共鸣解放领域 · 10 秒）<br>展开后选择 7 种欺骗程式消耗 Ram 点数（初始 24，2 链 32）。所有 Ram 消耗或时间结束时对所有标记目标发起<b>覆写篡改</b>。',
  ...
  '小孩子才做选择': '<b style="color:#ff8c5e">小孩子才做选择</b>（丽贝卡解放后强化）<br>施放重击·哒哒哒/砰砰砰后进入。攻击 +20%、暴伤 +20%，持续 30 秒。',
