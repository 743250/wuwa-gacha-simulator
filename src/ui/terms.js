...
export const TERM_DICT = {
  ...
  '气动侵蚀': '<b style="color:var(--green)">气动侵蚀</b>（卡提希娅 debuff）<br><b style="color:var(--accent)">共鸣技能·看潮怒风</b>给目标附加：受气动伤害 +15%，持续 3 回合。',
  '决意': '<b style="color:var(--gold)">决意</b>（卡提希娅共鸣回路）<br>积满到 30 / 60 / 90 / 120 时，每段给暴击伤害 +25%，可叠 <b>4</b> 层（最高 +100%，1 链）。',
